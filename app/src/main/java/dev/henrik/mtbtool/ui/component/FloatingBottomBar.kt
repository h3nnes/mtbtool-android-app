package dev.henrik.mtbtool.ui.component
...
import dev.henrik.mtbtool.ui.component.animation.DampedDragAnimation
import dev.henrik.mtbtool.ui.component.animation.InteractiveHighlight
...
// Height of the bar and the selected-tab indicator
...
fun FloatingBottomBar(
    ...
    Box(
        ...
        // ── Layer 1: outer glass bar (visible, draws the background blur + highlight) ──
        Row(
            Modifier
                ...
                .drawBackdrop(
                    ...
                    shape = { BarCorner },
                    effects = {
                        if (isBackdropBlurEnabled) blur(8f.dp.toPx())
        ...
        // ── Layer 2: invisible tab-scale layer (feeds tabsBackdrop for the indicator) ──
        ...
        // ── Layer 3: selected-tab indicator pill ──
        if (tabWidthPx > 0f) {
            Box(
                Modifier
                    ...
                    .drawBackdrop(
                        ...
                        effects = {
                            if (isLiquidGlassEnabled) {
                                val progress = dampedDragAnimation.pressProgress
                                lens(10f.dp.toPx() * progress, 14f.dp.toPx() * progress, true, true)
                            }
                        },
                        highlight = {
                            Highlight.Default.copy(alpha = if (isLiquidGlassEnabled) dampedDragAnimation.pressProgress else 0f)
